...
//when the const firstString=new Sentence("Hello,this is a sentence") is declared,it will call the "Sentence" function and then pass the "Hello,this is a sentence" to the "words" parameter
