...
const inventory=[ //saja buat contoh array ni store objects
    {price:5,name:"eggs"}, 
    {price:4,name:"ham"},
    {price:3,name:"mayo"},
    {price:5,name:"bread"}
...
const name=inventory.map((item)=>item.name) //kiranya dia akan buat array baru nama name
const prices=inventory.map((item)=>item.price)//kiranya dia akan buat array baru nama price
