...
//ARRAY
const animals = ["tortoises", "cats"];
const otherAnimals = animals; //otherAnimals elements will be "tortoises","cats"
...
console.log(animals); //"tortoises","cats","llamas"
console.log(otherAnimals); //"tortoises","cats","llamas"
