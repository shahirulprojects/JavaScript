...
const reversedString=exampleString1.split("").reverse().join(""); //reverse() and join() adalah array method so kena ubah string jadi array dulu baru boleh guna. join() method akan kita belajar di array nanti
