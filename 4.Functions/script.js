...
function square1(number){ //square tu nama function (can be anything you want),"number" dalam kurungan tu parameter
...
const square2 =function(number){ //setting the variable "square" to be a function expression
    return number*number;
}
...
//Example 7
//Arrow function 
//Set initial value for parameter in case paraemeter tu undefined
